...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FakeTeam.team'
        db.add_column(u'render_texdata_faketeam', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='aa', to=orm['contest.Team']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FakeTeam.team'
        db.delete_column(u'render_texdata_faketeam', 'team_id')
    ...
    models = {
        ...
        u'render_texdata.faketeam': {
            'Meta': {'object_name': 'FakeTeam', '_ormbases': [u'contest.Team']},
            'team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'aa'", 'to': u"orm['contest.Team']"}),
            u'team_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['contest.Team']", 'unique': 'True', 'primary_key': 'True'})
        },
