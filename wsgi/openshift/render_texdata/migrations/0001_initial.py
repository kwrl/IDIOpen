...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RenderCSV'
        db.create_table(u'render_texdata_rendercsv', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('latex_text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'render_texdata', ['RenderCSV'])

        # Adding model 'RenderTexOrEmail'
        db.create_table(u'render_texdata_rendertexoremail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('latex_text', self.gf('django.db.models.fields.TextField')()),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contest.Team'])),
        ))
        db.send_create_signal(u'render_texdata', ['RenderTexOrEmail'])


    def backwards(self, orm):
        # Deleting model 'RenderCSV'
        db.delete_table(u'render_texdata_rendercsv')

        # Deleting model 'RenderTexOrEmail'
        db.delete_table(u'render_texdata_rendertexoremail')
    ...
    models = {
        ...
        u'render_texdata.rendercsv': {
            'Meta': {'object_name': 'RenderCSV'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latex_text': ('django.db.models.fields.TextField', [], {})
        },
        u'render_texdata.rendertexoremail': {
            'Meta': {'object_name': 'RenderTexOrEmail'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latex_text': ('django.db.models.fields.TextField', [], {}),
