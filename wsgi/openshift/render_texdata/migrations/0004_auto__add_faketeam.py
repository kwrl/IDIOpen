...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FakeTeam'
        db.create_table(u'render_texdata_faketeam', (
            (u'team_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['contest.Team'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'render_texdata', ['FakeTeam'])


    def backwards(self, orm):
        # Deleting model 'FakeTeam'
        db.delete_table(u'render_texdata_faketeam')
