...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Latex_TeamText.team'
        db.add_column(u'render_texdata_latex_teamtext', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['contest.Team']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Latex_TeamText.team'
        db.delete_column(u'render_texdata_latex_teamtext', 'team_id')
