...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.skill_level'
        db.add_column(u'userregistration_customuser', 'skill_level',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=4),
                      keep_default=False)

        # Adding field 'CustomUser.gender'
        db.add_column(u'userregistration_customuser', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.skill_level'
        db.delete_column(u'userregistration_customuser', 'skill_level')

        # Deleting field 'CustomUser.gender'
        db.delete_column(u'userregistration_customuser', 'gender')
