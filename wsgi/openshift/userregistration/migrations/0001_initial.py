...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userregistration_customuser', (
        ...
        m2m_table_name = db.shorten_name(u'userregistration_customuser_groups')
        ...
        m2m_table_name = db.shorten_name(u'userregistration_customuser_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customuser', models.ForeignKey(orm[u'userregistration.customuser'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'userregistration_customuser')

        # Removing M2M table for field groups on 'CustomUser'
        db.delete_table(db.shorten_name(u'userregistration_customuser_groups'))

        # Removing M2M table for field user_permissions on 'CustomUser'
        db.delete_table(db.shorten_name(u'userregistration_customuser_user_permissions'))
