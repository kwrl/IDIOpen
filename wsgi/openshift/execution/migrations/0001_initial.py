...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'execution_fileextension', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('extension', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal(u'execution', ['FileExtension'])

        # Adding model 'CompilerProfile'
        db.create_table(u'execution_compilerprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('compiler_name_cmd', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('flags', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('package_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'execution', ['CompilerProfile'])

        # Adding M2M table for field extensions on 'CompilerProfile'
        m2m_table_name = db.shorten_name(u'execution_compilerprofile_extensions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('compilerprofile', models.ForeignKey(orm[u'execution.compilerprofile'], null=False)),
            ('fileextension', models.ForeignKey(orm[u'execution.fileextension'], null=False))
        ))
        db.create_unique(m2m_table_name, ['compilerprofile_id', 'fileextension_id'])

        # Adding model 'Problem'
        db.create_table(u'execution_problem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('textFile', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True)),
            ('date_uploaded', self.gf('django.db.models.fields.DateTimeField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userregistration.CustomUser'], null=True, on_delete=models.SET_NULL)),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contest.Contest'])),
        ))
        db.send_create_signal(u'execution', ['Problem'])

        # Adding model 'TestCase'
        db.create_table(u'execution_testcase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('inputFile', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('outputFile', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('short_description', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('inputDescription', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('outputDescription', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userregistration.CustomUser'], null=True, on_delete=models.SET_NULL)),
            ('problem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['execution.Problem'])),
        ))
        db.send_create_signal(u'execution', ['TestCase'])


    def backwards(self, orm):
        # Deleting model 'FileExtension'
        db.delete_table(u'execution_fileextension')

        # Deleting model 'CompilerProfile'
        db.delete_table(u'execution_compilerprofile')

        # Removing M2M table for field extensions on 'CompilerProfile'
        db.delete_table(db.shorten_name(u'execution_compilerprofile_extensions'))

        # Deleting model 'Problem'
        db.delete_table(u'execution_problem')

        # Deleting model 'TestCase'
        db.delete_table(u'execution_testcase')
