...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.compileProfile'
        db.add_column(u'execution_testcase', 'compileProfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['execution.CompilerProfile'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestCase.validator'
        db.add_column(u'execution_testcase', 'validator',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Resource.Max_filesize'
        db.delete_column(u'execution_resource', 'Max_filesize')

        # Adding field 'Resource.max_filesize'
        db.add_column(u'execution_resource', 'max_filesize',
                      self.gf('django.db.models.fields.IntegerField')(default=50, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.compileProfile'
        db.delete_column(u'execution_testcase', 'compileProfile_id')

        # Deleting field 'TestCase.validator'
        db.delete_column(u'execution_testcase', 'validator')
    ...
    models = {
        ...
        u'execution.testcase': {
            ...
            'compileProfile': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['execution.CompilerProfile']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'validator': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
