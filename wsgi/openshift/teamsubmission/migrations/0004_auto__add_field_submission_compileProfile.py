...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.compileProfile'
        db.add_column(u'teamsubmission_submission', 'compileProfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['execution.CompilerProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.compileProfile'
        db.delete_column(u'teamsubmission_submission', 'compileProfile_id')
