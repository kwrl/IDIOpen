...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'teamsubmission_submission', (
            ...
            ('submission', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('date_uploaded', self.gf('django.db.models.fields.DateTimeField')()),
            ('validated', self.gf('django.db.models.fields.BooleanField')()),
            ('text_feedback', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'teamsubmission', ['Submission'])


    def backwards(self, orm):
        # Deleting model 'Submission'
        db.delete_table(u'teamsubmission_submission')
