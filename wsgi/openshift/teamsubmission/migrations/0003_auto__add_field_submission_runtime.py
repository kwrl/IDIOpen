...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Submission.runtime'
        db.add_column(u'teamsubmission_submission', 'runtime',
                      self.gf('django.db.models.fields.IntegerField')(max_length=15, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Submission.runtime'
        db.delete_column(u'teamsubmission_submission', 'runtime')
