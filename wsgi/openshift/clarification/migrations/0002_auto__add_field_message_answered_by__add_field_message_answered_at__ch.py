...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.answered_by'
        db.add_column(u'clarification_message', 'answered_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userregistration.CustomUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Message.answered_at'
        db.add_column(u'clarification_message', 'answered_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Message.body'
        db.alter_column(u'clarification_message', 'body', self.gf('django.db.models.fields.TextField')(max_length=355))

        # Changing field 'Message.subject'
        db.alter_column(u'clarification_message', 'subject', self.gf('django.db.models.fields.CharField')(max_length=120))

    def backwards(self, orm):
        # Deleting field 'Message.answered_by'
        db.delete_column(u'clarification_message', 'answered_by_id')

        # Deleting field 'Message.answered_at'
        db.delete_column(u'clarification_message', 'answered_at')


        # Changing field 'Message.body'
        db.alter_column(u'clarification_message', 'body', self.gf('django.db.models.fields.CharField')(max_length=120))

        # Changing field 'Message.subject'
        db.alter_column(u'clarification_message', 'subject', self.gf('django.db.models.fields.TextField')())
