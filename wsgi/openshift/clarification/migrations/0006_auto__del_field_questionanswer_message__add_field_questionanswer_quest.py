...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionAnswer.message'
        db.delete_column(u'clarification_questionanswer', 'message_id')

        # Adding field 'QuestionAnswer.question'
        db.add_column(u'clarification_questionanswer', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clarification.Question'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'QuestionAnswer.message'
        db.add_column(u'clarification_questionanswer', 'message',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clarification.Question'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'QuestionAnswer.question'
        db.delete_column(u'clarification_questionanswer', 'question_id')
    ...
    models = {
        ...
        u'clarification.questionanswer': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contest.Contest']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['clarification.Question']", 'null': 'True', 'blank': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '120'})
        },
