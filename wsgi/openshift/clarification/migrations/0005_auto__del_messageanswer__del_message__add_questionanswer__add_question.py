...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clarification_questionanswer', (
            ...
            ('answered_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['userregistration.CustomUser'], null=True, blank=True)),
            ('answered_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clarification.Question'], null=True, blank=True)),
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contest.Contest'])),
        ))
        db.send_create_signal(u'clarification', ['QuestionAnswer'])

        # Adding model 'Question'
        db.create_table(u'clarification_question', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('body', self.gf('django.db.models.fields.TextField')(max_length=355)),
        ...
        db.send_create_signal(u'clarification', ['Question'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'clarification_messageanswer', (
            ...
            ('contest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contest.Contest'])),
            ('answered_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True)),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['clarification.Message'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.delete_table(u'clarification_questionanswer')

        # Deleting model 'Question'
        db.delete_table(u'clarification_question')
    ...
    models = {
        ...
        u'clarification.questionanswer': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contest.Contest']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['clarification.Question']", 'null': 'True', 'blank': 'True'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '120'})
        },
