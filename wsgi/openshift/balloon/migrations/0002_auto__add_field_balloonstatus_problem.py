...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BalloonStatus.problem'
        db.add_column(u'balloon_balloonstatus', 'problem',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['execution.Problem']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BalloonStatus.problem'
        db.delete_column(u'balloon_balloonstatus', 'problem_id')
    ...
    models = {
        ...
        u'balloon.balloonstatus': {
            ...
            'balloon_given': ('django.db.models.fields.BooleanField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
