...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BalloonStatus'
        db.create_table(u'balloon_balloonstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('balloon_given', self.gf('django.db.models.fields.BooleanField')()),
        ...
        db.send_create_signal(u'balloon', ['BalloonStatus'])


    def backwards(self, orm):
        # Deleting model 'BalloonStatus'
        db.delete_table(u'balloon_balloonstatus')
