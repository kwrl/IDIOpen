...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'balloon_view'
        db.create_table(u'balloon_balloon_view', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'balloon', ['balloon_view'])


    def backwards(self, orm):
        # Deleting model 'balloon_view'
        db.delete_table(u'balloon_balloon_view')
    ...
    models = {
        ...
        u'balloon.balloon_view': {
            'Meta': {'object_name': 'balloon_view'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'balloon.balloonstatus': {
            'Meta': {'object_name': 'BalloonStatus'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'execution.resource': {
            ...
            'max_memory': ('django.db.models.fields.IntegerField', [], {'default': '1024', 'max_length': '20'}),
            'max_processes': ('django.db.models.fields.IntegerField', [], {'default': '5', 'max_length': '10'}),
            'max_program_timeout': ('django.db.models.fields.IntegerField', [], {'default': '60', 'max_length': '5'}),
