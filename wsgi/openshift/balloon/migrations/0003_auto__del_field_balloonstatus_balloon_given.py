...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BalloonStatus.balloon_given'
        db.delete_column(u'balloon_balloonstatus', 'balloon_given')


    def backwards(self, orm):
        # Adding field 'BalloonStatus.balloon_given'
        db.add_column(u'balloon_balloonstatus', 'balloon_given',
