...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'contest_team', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Team.offsite'
        db.alter_column(u'contest_team', 'offsite', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Team.name'
        db.alter_column(u'contest_team', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Team.offsite'
        db.alter_column(u'contest_team', 'offsite', self.gf('django.db.models.fields.CharField')(max_length=200))
