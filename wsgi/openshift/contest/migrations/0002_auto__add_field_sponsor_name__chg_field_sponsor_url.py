...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sponsor.name'
        db.add_column(u'contest_sponsor', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Logo', max_length=50),
                      keep_default=False)


        # Changing field 'Sponsor.url'
        db.alter_column(u'contest_sponsor', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Sponsor.name'
        db.delete_column(u'contest_sponsor', 'name')


        # Changing field 'Sponsor.url'
        db.alter_column(u'contest_sponsor', 'url', self.gf('django.db.models.fields.CharField')(max_length=200))
