...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contest.penalty_constant'
        db.add_column(u'contest_contest', 'penalty_constant',
                      self.gf('django.db.models.fields.IntegerField')(default='0'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contest.penalty_constant'
        db.delete_column(u'contest_contest', 'penalty_constant')
